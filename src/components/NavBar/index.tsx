...
const NavBar = () => {
    return (
        <div className='z-50 fixed top-3 left-1/2 gap-4 -translate-x-1/2 text-center flex min-w-fit max-w-[90vw] justify-around navbar px-8 py-4 bg-background-dark/75 drop-shadow-md rounded-3xl'>
